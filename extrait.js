...
SoundPool.addDialogue("d0", "ecrans/00/titre.m4a");
for (var di = (start_scene === 0 ? 1 : start_scene); di <= end_scene; di++) {
    SoundPool.addDialogue("d" + di, 'ecrans/' + (di < 10 ? "0" + di : di) + '/' + di + '.m4a');
}

SoundPool.addSound("harpe", "ui/harpe.m4a");
...
scenes[scene_num].asset("ecrans/00/credits.png", {
    left: 709,
    top: 348,
    visible: true,
    autorun: false
...
scenes[scene_num].asset("ecrans/00/souris.png", {
    left: 155,
    top: 462,
    visible: true,
    autorun: false
});
scenes[scene_num].yeuxclos("ecrans/00/souris", {
    left: 235,
    top: 497,
    visible: true,
    autorun: false
...
scenes[scene_num].asset("ecrans/00/texte.png", {
    left: 427,
    top: 59,
    visible: true,
    autorun: false
...
scenes[scene_num].asset("ecrans/02/bn_24_259_432.png", {
    left: 124,
    top: 113,
    visible: true,
    autorun: false
...
scenes[scene_num].asset("ecrans/02/texte.png", {
    left: 436,
    top: 23,
    visible: true,
    autorun: false
...
scene_num = 3;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/03/texte_choix1.png", {
    left: 635,
    top: 483,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/03/texte_choix2.png", {
    left: 634,
    top: 533,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/03/mainverte.png", {
    left: 589,
    top: 534,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/03/mainrouge.png", {
    left: 589,
    top: 487,
    visible: true,
    autorun: false
...
scenes[scene_num].asset("ecrans/03/texte.png", {
    left: 617,
    top: 51,
    visible: true,
    autorun: false
...
scenes[scene_num].run = function() {
    ...
    me.navigationButton([".mainrouge", ".texte_choix1"], 98, 7);
    me.navigationButton([".mainverte", ".texte_choix2"], 4);
...
scene_num = 4;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/04/prince_08_135_299.png", {
    left: -200,
    top: 124,
    visible: true,
    autorun: true,
...
scenes[scene_num].asset("ecrans/04/arbre.png", {
    left: 0,
    top: 0,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/04/ecureuil_24_94_143.png", {
    left: 22,
    top: 55,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/04/oiseau_24_59_88.png", {
    left: 878,
    top: 65,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/04/prince_stop.png", {
    left: 401,
    top: 125,
    visible: false,
    autorun: true
});
scenes[scene_num].asset("ecrans/04/texte1.png", {
    left: 123,
    top: 443,
    visible: true,
    autorun: false
...
scenes[scene_num].run = function() {
    var me = this;
    me.enableNavigation();
    TweenMax.set(".prince_stop", {
        opacity: 0
    });
    TweenMax.fromTo(".prince", 5, {
        left: -200
    }, {
        left: 401,
        ease: Power1.easeOut,
...
scene_num = 5;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/05/choix1.png", {
    left: 72,
    top: 144,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/05/choix2.png", {
    left: 72,
    top: 195,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/05/mainverte.png", {
    left: 37,
    top: 198,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/05/mainrouge.png", {
    left: 37,
    top: 145,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/05/girouette_24_43_69.png", {
    left: 750,
    top: 48,
    visible: true,
    autorun: true
...
scenes[scene_num].asset("ecrans/05/prince_08_60_134.png", {
    left: -150,
    top: 350,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/05/prince_stop.png", {
    left: 611,
    top: 202,
    visible: false,
    autorun: true
});
scenes[scene_num].asset("ecrans/05/texte1.png", {
    left: 37,
    top: 52,
    visible: true,
    autorun: false
...
scenes[scene_num].run = function() {
    var me = this;
    me.disableNavigation();
    me.navigationButton([".mainrouge", ".choix1"], 6);
    me.navigationButton([".mainverte", ".choix2"], 11);
    //me.jumpToScene(8);
    TweenMax.set(".prince_stop", {
        opacity: 0
    });
...
scene_num = 6;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/06/prince_12_819_576.png", {
    left: 15,
    top: 0,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/06/texte1.png", {
    left: 552,
    top: 56,
    visible: true,
    autorun: false
...
scene_num = 7;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/07/bnmarche_12_208_374.png", {
    left: -250,
    top: 127,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/07/bnstop_22_208_374.png", {
    left: 210,
    top: 127,
    visible: false,
    autorun: true
});
scenes[scene_num].asset("ecrans/07/loup_25_434_488.png", {
    left: 357,
    top: 32,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/07/arbre.png", {
    left: 0,
    top: 0,
    visible: true,
    autorun: true
...
scenes[scene_num].run = function() {
    ...
    TweenMax.fromTo(".bnmarche", 3, {
        left: -250
    }, {
        left: 210,
        ease: Power1.easeOut,
        onComplete: function() {
            TweenMax.set(".bnmarche", {
                opacity: 0
            });
            TweenMax.set(".bnstop", {
                opacity: 1
...
scene_num = 8;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/08/bn_24_299_390.png", {
    left: 304,
    top: 186,
    visible: true,
    autorun: true
...
scenes[scene_num].asset("ecrans/08/loup_24_530_576.png", {
    left: 494,
    top: 0,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/08/texte1.png", {
    left: 21,
    top: 25,
    visible: true,
    autorun: false
...
scenes[scene_num].run = function() {
    ...
    me.find(".loup").delay(3).repeatDelay(3);
    me.find(".bn").repeatDelay(3);
};
...
scene_num = 9;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/09/prince_8_135_299.png", {
    left: -150,
    top: 42,
    visible: true,
    autorun: true
...
scenes[scene_num].asset("ecrans/09/texte1.png", {
    left: 30,
    top: 420,
    visible: true,
    autorun: false
...
scenes[scene_num].run = function() {
    var me = this;
    me.disableNavigation();
    TweenMax.to(".prince", 2, {
        left: 150,
        onComplete: function() {
            TweenMax.to(".prince", 0, {
                opacity: 0
            });
...
scenes[scene_num].asset("ecrans/10/prince_18_340_576.png", {
    left: 0,
    top: 0,
    visible: true,
    autorun: true,
...
scenes[scene_num].asset("ecrans/10/princeparle_18_340_576.png", {
    left: 0,
    top: 0,
    visible: false,
    autorun: true
...
scenes[scene_num].asset("ecrans/10/chaperon_24_591_312.png", {
    left: 215,
    top: 264,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/10/texte1.png", {
    left: 404,
    top: 30,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/10/choix1.png", {
    left: 770,
    top: 492,
    visible: false,
    autorun: false
});
scenes[scene_num].asset("ecrans/10/choix2.png", {
    left: 770,
    top: 541,
    visible: false,
    autorun: false
});
scenes[scene_num].asset("ecrans/10/mainverte.png", {
    left: 735,
    top: 534,
    visible: false,
    autorun: false
});
scenes[scene_num].asset("ecrans/10/mainrouge.png", {
    left: 729,
    top: 489,
    visible: false,
    autorun: false
...
scenes[scene_num].run = function() {
    var me = this;
    me.disableNavigation();
    me.navigationButton([".mainrouge", ".choix1"], 99);
    me.navigationButton([".mainverte", ".choix2"], 99);
    TweenMax.fromTo(".princeparle", 1.5, {
        opacity: 0
    }, {
        opacity: 0,
        onComplete: function() {
            ...
            TweenMax.to(".princeparle", 0, {
                opacity: 1
            });
        }

    });
    me.find(".chaperon").delay(3).play().repeatDelay(3);
    me.find(".princeparle").repeatDelay(3);

    TweenMax.set(".chaperon", { cursor: "pointer" });
    document.querySelector(".chaperon").addEventListener("click", function() {
        TweenMax.to(".chaperon", 0.25, { autoAlpha: 0 });
...
scene_num = 11;
scenes[scene_num] = new Scene(scene_num);
scenes[scene_num].asset("ecrans/11/lapin_25_108_156.png", {
    left: 776,
    top: 556,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/11/poisson2_12_78_65.png", {
    left: 300,
    top: 500,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/11/princefrappe_18_68_134.png", {
    left: 628,
    top: 208,
    visible: false,
    autorun: true
});
scenes[scene_num].asset("ecrans/11/princemarche_08_62_132.png", {
    left: 310,
    top: 228,
    visible: true,
    autorun: true
...
scenes[scene_num].run = function() {
    ...
    tl.to(".princemarche", 2, {
        left: 400,
        ease: Power0.easeNone
    });
    tl.to(".princemarche", 1.5, {
        left: 490,
        scale: 0.95,
        top: 203,
        ease: Power0.easeNone
    ...
    tl.to(".princemarche", 2, {
        ...
        ease: Power0.easeNone,
        onComplete: function() {
            me.find(".princemarche").pause();
            TweenMax.to(".princemarche", 0, {
                opacity: 0
            });
            TweenMax.to(".princefrappe", 0, {
                opacity: 1,
                onComplete: function() {
                    me.find(".princefrappe").play();
                }
            });
            tl.to(".princefrappe", 2, {
                opacity: 1,
                onComplete: function() {
                    me.find(".princefrappe").pause();
                }
            })
        }
    });
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/12/princecorps.png", {
//     left: 277,
//     top: 318,
//     visible: true,
//     autorun: true
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/12/farine.png", {
//     left: 930,
//     top: 474,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/12/levure.png", {
//     left: 964,
//     top: 517,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/12/cache.png", {
//     left: 867,
//     top: 513,
//     visible: true,
//     autorun: false
...
//         }
//     };
//     TweenMax.set([".levure", ".farine", ".vide"], { cursor: "pointer" });

//     document.querySelector(".vide").addEventListener("click", function() {
//         TweenMax.to(".levure", 0, {
//             opacity: 0,
//             onComplete: function() {
//                 SoundPool.playSound('harpe', this);
//                 addCpt();
//                 document.querySelector(".vide").addEventListener("click", function() {
//                     TweenMax.to(".farine", 0, { opacity: 0 });
...
// scene_num = 13;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/13/princemarche_08_175_414.png", {
//     left: -180,
//     top: 130,
//     visible: true,
//     autorun: true
...
//     tl.to(".princemarche", 3, {
//         left: 60,
//         onComplete: function() {
//             me.find(".princemarche").pause();
//         }
//     });
//     tl.to(".princemarche", 1, {
//         opacity: 1
//     });

//     tl.to(".princemarche", 5, {
//         onStart: function() {
//             me.find(".princemarche").play();
//         },
//         left: 600,
//         top: 160,
//         scale: 0.5
...
// scene_num = 14;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/14/fondblanc.png", {
//     left: 730,
//     top: 459,
//     visible: false,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/14/texte_choix1.png", {
//     left: 789,
//     top: 481,
//     visible: false,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/14/texte_choix2.png", {
//     left: 789,
//     top: 522,
//     visible: false,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/14/mainverte.png", {
//     left: 753,
//     top: 531,
//     visible: false,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/14/mainrouge.png", {
//     left: 753,
//     top: 483,
//     visible: false,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/14/grandmere_24_301_262.png", {
//     left: 694,
//     top: 204,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/14/fumeedestasses_12_72_69.png", {
//     left: 540,
//     top: 369,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/14/princeassis_24_210_442.png", {
//     left: 501,
//     top: 11,
//     visible: true,
//     autorun: true
...
// scenes[scene_num].run = function() {
//     var me = this;
//     me.find(".princeassis").repeatDelay(3);
//     me.find(".grandmere").delay(3).repeatDelay(3);
//     me.disableNavigation();
//     me.navigationButton([".mainverte", ".texte_choix2"], 97, 21);
//     me.navigationButton([".mainrouge", ".texte_choix1"], 97, 19);
//     TweenMax.fromTo(".princeassis", 0, {
//         opacity: 1
//     }, {
//         opacity: 0,
//         onComplete: function() {
//             TweenMax.set(".princeassis", {
//                 opacity: 1
//             });
//         }
//     });
//     TweenMax.fromTo(".grandmere", 0, {
//         opacity: 1
//     }, {
//         opacity: 0,
//         onComplete: function() {
//             TweenMax.set(".grandmere", {
//                 opacity: 1
//             });
//         }
//     });
...
//         TweenMax.to([".mainverte", ".mainrouge", ".texte_choix1", ".texte_choix2", ".fondblanc"], 0, {
//             opacity: 1
//         })
...
// scene_num = 15;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/15/bdor.png", {
//     left: 0,
//     top: 0,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/15/bdo_25_91_94.png", {
//     left: 788,
//     top: 97,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/15/prince_08_195_394.png", {
//     left: 0,
//     top: 52,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/15/princestopetparle_22_195_394.png", {
//     left: 0,
//     top: 52,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/15/raton_25_128_109.png", {
//     left: 726,
//     top: 287,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/15/raton2_25_190_106.png", {
//     left: 38,
//     top: 470,
//     visible: true,
//     autorun: true
...
//     tl.to(".prince", 3, {
//         onStart: function() {
//             me.find(".princestopetparle").play().repeatDelay(3);
//         },

//         onComplete: function() {
//             me.find(".bdo").repeatDelay(2.8).play();
//         }
//     })
// };
...
// scene_num = 16;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/16/bdor.png", {
//     left: 516,
//     top: 223,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/16/bdorparle_25_206_181.png", {
//     left: 600,
//     top: 349,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/16/princecorps.png", {
//     left: 4,
//     top: 251,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/16/princeparle_25_369_354.png", {
//     left: 0,
//     top: 0,
//     visible: true,
//     autorun: false
...
//     tl.to(".bdorparle", 3, {
//         onStart: function() {
//             me.find(".bdorparle").play().repeatDelay(3.5);
//         },

//         onComplete: function() {
//             me.find(".princeparle").repeatDelay(2.8).play();
//         }
//     })
// };
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/17/prince_25_95_463.png", {
//     left: 0,
//     top: 30,
//     visible: true,
//     autorun: true
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/17/abeille_25_218_178.png", {
//     left: 737,
//     top: 15,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/17/mamanourse_25_148_121.png", {
//     left: 762,
//     top: 266,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/17/ourson_25_147_87.png", {
//     left: 136,
//     top: 350,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/17/papaours_25_166_95.png", {
//     left: 517,
//     top: 222,
//     visible: true,
//     autorun: true
...
// scenes[scene_num].asset("ecrans/18/mamanourse_25_162_124.png", {
//     left: 755,
//     top: 288,
//     visible: true,
//     autorun: true
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/18/papaours_25_148_118.png", {
//     left: 519,
//     top: 238,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/18/princecorps.png", {
//     left: 223,
//     top: 228,
//     visible: true,
//     autorun: false
...
// scenes[scene_num].asset("ecrans/18/prince_25_285_289.png", {
//     left: 189,
//     top: -1,
//     visible: true,
//     autorun: true
...
//     });
//     me.find(".papaours").repeatDelay(3);
//     me.find(".prince").delay(3).repeatDelay(3);
// };
...
// scene_num = 19;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/19/princemefiant_25_383_473.png", {
//     left: -300,
//     top: 148,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/19/sorciere_25_662_576.png", {
//     left: 1200,
//     top: 0,
//     visible: true,
//     autorun: false
...
//     TweenMax.to(".princemefiant", 3, {
//         left: 0,
//         onComplete: function() {
//             me.find(".princemefiant").play().delay(3).repeatDelay(3);
//         }
//     });
//     TweenMax.to(".sorciere", 3, {
//         left: 362,
//         onComplete: function() {
//             me.find(".sorciere").play().repeatDelay(3);
//         }
//     });
// };
...
// scene_num = 20;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/20/princeinquiet_25_183_413.png", {
//     left: 37,
//     top: 149,
//     visible: true,
//     autorun: true
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/20/sorcieresanspomme.png", {
//     left: 201,
//     top: 100,
//     visible: false,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/20/sorciere_25_460_492.png", {
//     left: 166,
//     top: 83,
//     visible: true,
//     autorun: true
...
//     var me = this;
//     me.disableNavigation();
//     TweenMax.set(".sorciere", {
//         cursor: "pointer"
//     });
//     document.querySelector(".sorciere").addEventListener("click", function() {
//         SoundPool.playSound('harpe', this);
//         TweenMax.to(".sorcieresanspomme", 0, {
//             opacity: 1
//         });
//         TweenMax.to(".sorciere", 0, {
//             opacity: 0
//         });
//         me.enableNavigation();
...
// scene_num = 21;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/21/bonhom1_25_446_291.png", {
//     left: 576,
//     top: 287,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/21/bonhomX2_25_253_167.png", {
//     left: 163,
//     top: 208,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/21/fumee_24_201_83.png", {
//     left: 445,
//     top: 1,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/21/prince_24_276_468.png", {
//     left: 0,
//     top: 109,
//     visible: true,
//     autorun: true
...
// scene_num = 22;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/22/prince_25_157_260.png", {
//     left: 0,
//     top: 110,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/22/hansel_8_252_310.png", {
//     left: 300,
//     top: 192,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/22/gretel_10_334_314.png", {
//     left: 473,
//     top: 310,
//     visible: true,
//     autorun: false
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/22/fruitsconfits.png", {
//     left: 390,
//     top: 147,
//     visible: true,
//     autorun: false
...
//     me.makeObjectDisappear([".fruitsconfits"], function() {
//         me.enableNavigation();
...
// scene_num = 23;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/23/poucet_30_273_215.png", {
//     left: 337,
//     top: 339,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/23/prince_25_160_328.png", {
//     left: 864,
//     top: 33,
//     visible: true,
//     autorun: true
...
// scene_num = 24;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/24/enfants_30_94_78.png", {
//     left: 723,
//     top: 122,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/24/frered_30_141_106.png", {
//     left: 511,
//     top: 329,
//     visible: true,
//     autorun: true
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/24/sac.png", {
//     left: 807,
//     top: 165,
//     visible: true,
//     autorun: false
...
//     autorun: false
// });
// scenes[scene_num].yeuxclos("ecrans/24/enfmilieu", {
//     left: 215,
//     top: 195,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].yeuxclos("ecrans/24/enfgauche", {
//     left: 0,
//     top: 167,
//     visible: true,
//     autorun: false
...
//     var me = this;
//     me.disableNavigation();
//     me.makeObjectDisappear([".sac"], function() {
//         me.enableNavigation();
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/25/chien_24_270_141.png", {
//     left: 755,
//     top: 412,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/25/ecurueilin_22_121_109.png", {
//     left: 902,
//     top: 0,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/25/ecurueil_25_85_76.png", {
//     left: 902,
//     top: 35,
//     visible: false,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/25/jambon.png", {
//     left: 425,
//     top: 347,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/25/fromage.png", {
//     left: 677,
//     top: 425,
//     visible: true,
//     autorun: false
...
//     me.makeObjectDisappear([".jambon", ".fromage"], addCpt);


//     me.find(".ecurueilin").play().repeat(0);
//     TweenMax.to(".ecurueil", 2.5, {
//         opacity: 0,
//         onComplete: function() {
//             TweenMax.to(".ecurueil", 0, {
//                 opacity: 1
//             });
//             TweenMax.to(".ecurueilin", 0, {
//                 opacity: 0
//             });
//         }
//     });
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/26/mainrouge.png", {
//     left: 694,
//     top: 503,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/26/mainverte.png", {
//     left: 694,
//     top: 535,
//     visible: true,
//     autorun: false
...
//     var me = this;
//     me.enableNavigation();
//     me.navigationButton([".mainverte", ".choix226"], 98, 29);
//     me.navigationButton([".mainrouge", ".choix126"], 27);
// };
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/27/gateau.png", {
//     left: 262,
//     top: 328,
//     visible: true,
//     autorun: false
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/28/mainverte.png", {
//     left: 694,
//     top: 535,
//     visible: false,
//     autorun: false
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/28/mainrouge.png", {
//     left: 694,
//     top: 503,
//     visible: false,
//     autorun: false
...
//     var me = this;
//     me.disableNavigation();
//     me.navigationButton([".mainverte", ".choix228"], 36);
//     me.navigationButton([".mainrouge", ".choix128"], 33);
...
//             opacity: 1
//         });
//         TweenMax.set([".choix128", ".choix228", ".mainrouge", ".mainverte"], {
//             opacity: 1,
//             cursor: "pointer"
//         });
//         SoundPool.playSound('harpe', this);
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/32/mainverte.png", {
//     left: 742,
//     top: 536,
//     visible: false,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/32/mainrouge.png", {
//     left: 742,
//     top: 504,
//     visible: false,
//     autorun: false
...
// scenes[scene_num].asset("ecrans/32/feesansvanille.png", {
//     left: 463,
//     top: 263,
//     visible: false,
//     autorun: true
...
//     var me = this;
//     me.disableNavigation();
//     me.navigationButton([".mainverte", ".choix232"], 41);
//     me.navigationButton([".mainrouge", ".choix132"], 98, 38);
//     TweenMax.set(".fee32", {
//         cursor: "pointer"
//     });
...
//             opacity: 0
//         });
//         TweenMax.to(".feesansvanille", 0, {
//             opacity: 1
//         });
//         TweenMax.to([".mainrouge", ".mainverte", ".choix132", ".choix232"], 0, {
//             opacity: 1
//         });
//         SoundPool.playSound('harpe', this);
//     });
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/34/ombrefarine.png", {
//     left: 411,
//     top: 255,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/34/farine.png", {
//     left: 428,
//     top: 204,
//     visible: true,
//     autorun: false
...
//     document.querySelector(".farine").addEventListener("click", function() {
//         SoundPool.playSound('harpe', this);
//         TweenMax.to(".farine", 0, {
//             opacity: 0
//         });
//         me.enableNavigation();
//     });
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/35/levure.png", {
//     left: 289,
//     top: 522,
//     visible: true,
//     autorun: false
...
// scene_num = 50;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/50/cat_24_150_72.png", {
//     left: 182,
//     top: 247,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/50/bnrobe.png", {
//     left: 73,
//     top: 282,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/50/bn_25_147_148.png", {
//     left: 40,
//     top: 91,
//     visible: true,
//     autorun: true
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/50/prince_24_180_178.png", {
//     left: 382,
//     top: 47,
//     visible: true,
//     autorun: true
...
// scene_num = 51;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/51/sorciererire_24_113_82.png", {
//     left: 741,
//     top: 29,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/51/sorcierein_30_113_82.png", {
//     left: 741,
//     top: 29,
//     visible: true,
//     autorun: true
...
// scenes[scene_num].asset("ecrans/51/princecorps.png", {
//     left: 333,
//     top: 198,
//     visible: true,
//     autorun: false
...
//     var me = this;
//     me.enableNavigation();
//     TweenMax.to(".sorcierein", 2, {
//         left: 741,
//         onComplete: function() {
//             me.find(".sorcierein").pause();
//             TweenMax.to(".sorcierein", 0, {
//                 opacity: 0
//             });
//             TweenMax.to(".sorciererire", 0, {
//                 opacity: 1,
//             });
//         }
//     });
...
// scene_num = 52;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/52/bn_24_643_576.png", {
//     left: -2,
//     top: 0,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/52/prince_24_228_378.png", {
//     left: 695,
//     top: 0,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/52/plat_12_125_138.png", {
//     left: 857,
//     top: 284,
//     visible: true,
//     autorun: true
...
// scene_num = 53;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/53/nain3_21_153_282.png", {
//     left: 871,
//     top: 178,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/53/nain1_20_256_298.png", {
//     left: 640,
//     top: 278,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/53/nain4_12_203_209.png", {
//     left: 720,
//     top: 91,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/53/bn_8_328_465.png", {
//     left: 0,
//     top: 27,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/53/prince_8_129_336.png", {
//     left: 614,
//     top: 10,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/53/nain2_18_201_250.png", {
//     left: 832,
//     top: 330,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/53/tablepremierplan.png", {
//     left: 0,
//     top: 359,
//     visible: true,
//     autorun: true
...
// scene_num = 54;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/54/bncorps.png", {
//     left: 435,
//     top: 116,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/54/bn_25_102_94.png", {
//     left: 450,
//     top: 69,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/54/chat_12_201_140.png", {
//     left: 771,
//     top: 414,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/54/princeparle_24_175_415.png", {
//     left: 251,
//     top: 5,
//     visible: false,
//     autorun: true
...
//                 opacity: 0
//             });
//             TweenMax.set(".princeparle", {
//                 opacity: 1
//             });
//             me.find(".bn").play().repeatDelay(3);
//         }
//     });
//     me.find(".princeparle").delay(3).repeatDelay(3);
// };
...
// scene_num = 55;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/55/bncorps.png", {
//     left: 378,
//     top: 239,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/55/princecorps.png", {
//     left: 590,
//     top: 140,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/55/bn_25_267_212.png", {
//     left: 380,
//     top: 110,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/55/prince_24_117_217.png", {
//     left: 592,
//     top: 35,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/55/gretel_24_167_212.png", {
//     left: 857,
//     top: 112,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/55/hansel_24_209_274.png", {
//     left: 715,
//     top: 113,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/55/fumee54_12_54_69.png", {
//     left: 969,
//     top: 98,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/55/premierplantable.png", {
//     left: 0,
//     top: 388,
//     visible: true,
//     autorun: false
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/55/greteljambes.png", {
//     left: 876,
//     top: 319,
//     visible: true,
//     autorun: false
...
//     var me = this;
//     me.enableNavigation();
//     me.find(".prince").repeatDelay(6);
//     me.find(".hansel").delay(3).repeatDelay(3);
//     me.find(".gretel").delay(6).repeatDelay(3);
// };
...
// scene_num = 56;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/56/bncorps.png", {
//     left: 159,
//     top: 235,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/56/bn_25_132_107.png", {
//     left: 166,
//     top: 175,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/nain1_24_149_119.png", {
//     left: 320,
//     top: 211,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/nain2_24_133_133.png", {
//     left: 460,
//     top: 197,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/nain3_24_140_135.png", {
//     left: 580,
//     top: 200,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/nain7_24_197_252.png", {
//     left: 141,
//     top: 270,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/gretel_24_109_142.png", {
//     left: 714,
//     top: 221,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/princecorps.png", {
//     left: 780,
//     top: 233,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/56/prince_24_148_145.png", {
//     left: 796,
//     top: 130,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/hansel_24_192_295.png", {
//     left: 834,
//     top: 281,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/56/table.png", {
//     left: 184,
//     top: 288,
//     visible: true,
//     autorun: false
...
//     }, "cake");
//     me.find(".prince").repeatDelay(3);
//     me.find(".bn").delay(3).repeatDelay(3);
// };
...
// scene_num = 57;
// scenes[scene_num] = new Scene(scene_num);
// scenes[scene_num].asset("ecrans/57/bn_24_259_383.png", {
//     left: 370,
//     top: 143,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/57/prince.png", {
//     left: 74,
//     top: 168,
//     visible: true,
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/57/prince_24_132_150.png", {
//     left: 97,
//     top: 47,
//     visible: true,
//     autorun: true
...
// scenes[scene_num].asset("ecrans/58/prince_24_339_576.png", {
//     left: 496,
//     top: 0,
//     visible: true,
//     autorun: true
...
//     autorun: false
// });
// scenes[scene_num].asset("ecrans/58/bn_24_331_496.png", {
//     left: 357,
//     top: 81,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/58/fumee_12_54_69.png", {
//     left: 955,
//     top: 86,
//     visible: true,
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/58/premierplantable.png", {
//     left: 0,
//     top: 330,
//     visible: true,
//     autorun: false
...
//         }
//     });
//     me.find(".prince").play().repeatDelay(3);
//     me.find(".bn").play().delay(3).repeatDelay(3);
...
//     autorun: true
// });
// scenes[scene_num].asset("ecrans/64/fesseprince.png", {
//     left: 872,
//     top: 440,
//     visible: true,
//     autorun: false
...
scenes[scene_num].asset("ecrans/97/arbre.png", {
    left: 0,
    top: 0,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/97/ecureuil_24_94_143.png", {
    left: 22,
    top: 55,
    visible: true,
    autorun: true
});
scenes[scene_num].asset("ecrans/97/oiseau_24_59_88.png", {
    left: 878,
    top: 65,
    visible: true,
    autorun: true
...
scenes[scene_num].asset("ecrans/98/troncnoir.png", {
    left: 0,
    top: 0,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/98/ecureuil.png", {
    left: 28,
    top: 62,
    visible: true,
    autorun: false
});
scenes[scene_num].yeuxclos("ecrans/98/test", {
    left: 75,
    top: 71,
    visible: true,
    autorun: false
});
scenes[scene_num].asset("ecrans/98/oiseau.png", {
    left: 878,
    top: 67,
    visible: true,
    autorun: false
});
scenes[scene_num].yeuxclos("ecrans/98/oiseau", {
    left: 892,
    top: 92,
    visible: true,
    autorun: false
...
scenes[scene_num].run = function() {
    ...
    me.enablePrevious();
    // retour à l'accueil
    me.navigationButton([".previous"], 0);
};